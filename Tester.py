...
textFile = open('cloth_info.txt', 'w');
textColor = open('color_info.txt', 'w');
#print(sys.argv[3])
#print(sys.argv[4])

#textAll = open('all_info.txt', 'w');
...
def detect_labels(path):
    ...
    #for i in labels:
     #   print("This is labels: %s \n", labels)

    
    for label in labels:
        #print(label.description)
        #searchObj = re.search(r'coat',label.description, re.M|re.I)

        if (re.match(r'coat',label.description, re.M|re.I) or re.match(r'shirt',label.description, re.M|re.I) or re.match(r'pant',label.description, re.M|re.I) or re.match(r'dress',label.description, re.M|re.I) or re.match(r'short',label.description, re.M|re.I) or re.match(r'jacket',label.description, re.M|re.I) or re.match(r'jean',label.description, re.M|re.I)):
            textFile.write(label.description + '\n') #Writing to a textfile.
        elif (re.match(r'black',label.description, re.M|re.I) or re.match(r'blue',label.description, re.M|re.I) or re.match(r'green',label.description, re.M|re.I) or re.match(r'orange',label.description, re.M|re.I) or re.match(r'red',label.description, re.M|re.I) or re.match(r'brown',label.description, re.M|re.I) or re.match(r'grey',label.description, re.M|re.I) or re.match(r'purple',label.description, re.M|re.I) or re.match(r'yellow',label.description, re.M|re.I) or re.search(r'formal',label.description, re.M|re.I)):
            textFile.write(label.description + '\n')


        #textAll.write(label.description + '\n')
...
def detect_properties(path):
    ...
    for prop in properties:
        color = prop.colors[0]
        textFile.write('fraction: {}'.format(color.pixel_fraction) + '\n')

        textFile.write('r: {}'.format(color.color.red) + '\n')
        textFile.write('g: {}'.format(color.color.green) + '\n')
        textFile.write('b: {}'.format(color.color.blue) + '\n')
...
def run_all_local():
    ...
    file_name = os.path.join(
        ...
        '/Users/nicholascheung/Desktop/black_t_shirt.jpeg')
...
def run_labels_and_properties(args):
    if args.command == 'l_and_p':
...
# for filename in os.listdir('/Users/nicholascheung/Desktop/Programs/Hackathon_2017/H_pics'):
